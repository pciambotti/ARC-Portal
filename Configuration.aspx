<%@ Page Title="Configuration" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Configuration.aspx.cs" Inherits="Configuration" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Master_Content" runat="Server">
    ...
    <div id="default_container">
        ...
        <div id="reporting_filters" class="reporting_filters">
            <div class="clearfix">
                <div id="filter_workon" class="filter_section">
                    <h3>What to work on</h3>
                    <div id="workon">
                        <div class="filter_label1">
                            Select
                        </div>
                        <asp:DropDownList ID="ddlWorkOn" runat="server" Width="128px" Width2="250px">
                            <asp:ListItem Value="100000" Text="Designations" />
                            <asp:ListItem Value="200000" Text="Script Sections" />
                        </asp:DropDownList>
                        <div style="margin-left: 25px;">
                            After changing your selection, refresh the list
                        </div>
                    </div>
                </div>
        ...
        <div id="search_result" class="clearfix">
            <div id="designation_grid" style="display: inline-block;vertical-align: top;">
                <asp:UpdatePanel ID="upDesignationGrid" runat="server">
                    ...
                    <ContentTemplate>
                        ...
                        <div id="grid_designation" style="display: block;width: 515px;vertical-align: top;" runat="server">
                            ...
                            <asp:Label ID="lblDesignationList" runat="server" Text="" />
                        </div>
                        <div id="grid_script_section" style="display: block;width: 515px;vertical-align: top;" runat="server">
                            <asp:GridView ID="gvScriptSectionList" runat="server" AutoGenerateColumns="False"
                                BackColor="White"
                                BorderStyle="None"
                                BorderWidth="1px"
                                BorderColor="#DEDFDE"
            ...
            <div id="designation_details" style="display: inline-block;vertical-align: top;">
                                    ...
                                    <Fields>
                                        ...
                                        <asp:TemplateField HeaderText="Fund Code">
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <asp:Textbox ID="fundcode" runat="server" Text='<%# Eval("fundcode") %>' Width="50px" Enabled="false" MaxLength="4" />
                                                <div style="display: inline;margin-left: 5px;">
                                                    Only IT may change
                                                </div>
                                            </EditItemTemplate>
                                            <InsertItemTemplate>
                                                <asp:Textbox ID="fundcode" runat="server" Text='<%# Eval("fundcode") %>' Width="50px" />
                                                <asp:RequiredFieldValidator
                                                ...
                                                <asp:RegularExpressionValidator
                                                    ...
                                                    Text="*"
                                                    SetFocusOnError="false"
                                                    ErrorMessage="fundcode must be 4 digits long"
                ...
                <asp:UpdatePanel ID="upScriptSectionDetails" runat="server">
                    <ContentTemplate>
                        <asp:Label Font-Bold="true" ID="Label2" runat="server" Text="" />
                        <div>
                            <asp:Button ID="Button1" runat="server" Text="Add New Designation" OnClick="Designation_Add_Click" Visible="false" />
                        </div>
                        <div style="width: 575px">
                            <div>
                            ...
                            <div style="margin-top: 5px;">
                                <asp:DetailsView ID="DetailsView1" runat="server" DataKeyNames="designationid"
                                    AutoGenerateRows="False" ForeColor="Black" GridLines="Vertical"
                                    HeaderText="Designation Details"
                                    CssClass="User_List_Details_Border"
                                    Width="550px"
