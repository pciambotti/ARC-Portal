<%@ Page Title="Search" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Search_Old.aspx.cs" Inherits="Search_Old" %>
            ...
            <div class="clearfix">
                ...
                <div id="filter_to" class="filter_section">
                    ...
                    <div id="donation_dnis_list">
                        ...
                        <asp:ListBox ID="ddlDNISList" runat="server" SelectionMode="Multiple" Width="130px" Width2="300px" multiple="multiple" CssClass="multiselect" />
                    </div>
                </div>
                <div id="filter_options" class="filter_section">
                    ...
                    <div id="donation_exclude_tests">
                        <asp:Label ID="Label18" runat="server" Text="Exclude Test CC" CssClass="filter_label1" />
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Dialed Line">
                                    <ItemTemplate>
                                        <asp:Label ID="DNIS" runat="server" Text='<%# Eval("DNIS").ToString() %>' ForeColor="Blue" />
                                        <asp:Label ID="DNIS_Description" runat="server" Text='<%# Eval("DNIS_Description").ToString() %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            <div id="search_details" style="display: block;vertical-align: top;">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        ...
                        <div style="display: inline-block;vertical-align: top;">
                            <asp:DetailsView ID="dvDonorDetails" runat="server" DataKeyNames="CallID"
                                ...
                                <Fields>
                                    ...
                                    <asp:BoundField HeaderText="Email" DataField="ackaddress" ReadOnly="true" Visible="false" />
                    ...
                    <div class="clearfix">
                        ...
                        <div style="display: inline-block;vertical-align: top;">
                            <h3 id="lblGiftList" runat="server" visible="false">Gift List</h3>
                    ...
                    <div class="clearfix">
                        <div style="display: inline-block;vertical-align: top;">
                            <asp:DetailsView ID="dvSustainerDetails" runat="server" DataKeyNames="CallID"
                                ...
                                <EmptyDataTemplate>
                                    No [Sustainer] details;
                                </EmptyDataTemplate>
                            </asp:DetailsView>
                        </div>
                        <div style="display: inline-block;vertical-align: top;">
                            <h3 id="lblRecurringList" runat="server" visible="false">Recurring List</h3>
