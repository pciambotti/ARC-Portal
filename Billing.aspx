<%@ Page Title="Billing" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Billing.aspx.cs" Inherits="Billing" %>
            ...
            <div class="clearfix">
                <div id="filter_dates" class="filter_section">
                    ...
                    <div id="datetime_start">
                        ...
                        <asp:TextBox ID="dtStartTime" runat="server" Width="60px" CssClass="ghTimePickerStart" />
                    </div>
                    <div id="datetime_end">
                        ...
                        <asp:TextBox ID="dtEndTime" runat="server" Width="60px" CssClass="ghTimePickerEnd" />
                    </div>
