<%@ Page Title="Dashboard" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Dashboard_Other.aspx.cs" Inherits="Dashboard_Other" %>
        ...
        <div id="default_container"  style="margin-left: 5px;">
            ...
            <div id="reporting_filters" class="reporting_filters">
                <div class="clearfix">
                    ...
                    <div id="filter_clients" class="filter_section">
                        <h3>Client</h3>
                    ...
                    <div id="filter_campaigns" class="filter_section">
                        <h3>Campaign</h3>
                            ...
                            <div style="width: 100%;vertical-align: top;height: 30px;">
                                <div class="report-controls" style="vertical-align: top;height: 30px;">
                                    ...
                                    <div style="display: inline-block;margin-left: 25px;">
                                        <asp:Button ID="btnSelectiveReport" runat="server" Text="Selective Reporting" OnClick="GoTo_Selective_Report" Visible="true" />
                                    </div>
                                    <div style="display: inline-block;margin-left: 25px;">
